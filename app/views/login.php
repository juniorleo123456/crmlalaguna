...
<head>
    ...
    <link href="/assets/css/styles.css" rel="stylesheet"> <!-- Tu CSS custom -->
...
<body class="bg-light">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            <img src="/assets/img/logo-lalaguna.svg" alt="Logo CRMLalaguna" class="logo mb-3">
                        ...
                        <div class="text-center small text-muted">
                            ...
                            <a href="/dashboard?role=socio">Socio</a> |
                            <a href="/dashboard?role=cliente">Cliente</a>
                        </div>
                    </div>
                </div>

                <p class="text-center text-muted small mt-3">
                    Desarrollado con MVC PHP – <code>http://lalaguna.local/</code>
                </p>
            </div>
        </div>
    </div>
    ...
    <script src="/assets/js/app.js"></script> <!-- Si tienes JS custom -->
</body>
